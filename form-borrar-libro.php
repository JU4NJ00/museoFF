...
include('primero.php');
 ...
 <div class="row">
  ...
  <div class="btn btn-danger btn-sm"> <a class="text-decoration-none text-white" href="lista_libros_borrados.php">Cancelar</a></div>
</div>

<form class="row g-3" action="borrar-restaurar_libros.php" method="post">
 ...
 <?php
   ...
   if (isset($_GET["msje"])){
      ...
      if($_GET["msje"]!="ok"){
        ...
        echo "<div class='text-center mt-4 mb-5'><div class='alert alert-danger' role='alert'><strong>".$_GET["msje"]."</strong><a href='lista_libros_borrados.php' class='text-primary ms-3'>Volver al Listado</a></div></div>"; 
        
      }else{

              
        echo "<div class='text-center mt-4 mb-5'><div class='alert alert-success' role='alert'><strong>"."Actualización Exitosa!"."</strong><a href='lista_libros_borrados.php' class='text-primary ms-3'>Volver al Listado</a></div></div>";  
