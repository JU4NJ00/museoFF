...
include('primero.php');
 ...
 <div class="text-center my-5 text-primary"><h2>Eliminar elemento del inventario de forma definitiva</h2></div>	

 <div class="row">
  <div class="col-11"></div>
  <div class="col-1 text-right">
  <div class="btn btn-danger btn-sm"> <a class="text-decoration-none text-white" href="lista_muebles_borrados.php">Cancelar</a></div>
</div>

 <form class="row g-3" action="borrar-restaurar_mueble.php" method="post">
 ...
 <div class="col-12 text-center">
    <div> <h5> ¿Estas segur@ que quieres eliminar a este elemento de forma definitiva?</h5>
        <br>
 <button type="submit" name="borrar" class="btn btn-success btn-sm">Confirmar</button>
 <button type="submit" name="restaurar" class="btn btn-success btn-sm">Restaurar</button>
  ...
  <?php
   ...
   if (isset($_GET["msje"])){
      ...
      if($_GET["msje"]!="ok"){
        ...
        echo "<div class='text-center mt-4 mb-5'><div class='alert alert-danger' role='alert'><strong>".$_GET["msje"]."</strong><a href='lista_muebles_borrados.php' class='text-primary ms-3'>Volver al Listado</a></div></div>"; 
        
      }else{

              
        echo "<div class='text-center mt-4 mb-5'><div class='alert alert-success' role='alert'><strong>"."Actualización Exitosa!"."</strong><a href='lista_muebles_borrados.php' class='text-primary ms-3'>Volver al Listado</a></div></div>";  
