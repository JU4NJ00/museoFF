    ...
    <div class="container text-center ">
        ...
        <table class="table table-striped table-hover">
            ...
            ?>
                    ...
                    <a class="me-1 btn btn-outline-success btn-sm " href="form-edit-cat2.php?id=<?php echo $fila ['idcategorias'];?>"><i class="fa fa-pencil fa-1x" aria-hidden="true"></i></a>
              
                    <a class="me-1 btn btn-outline-danger btn-sm" href="form-eliminar-cate2.php?id=<?php echo $fila ['idcategorias'];?>"><i class="fa fa-trash fa-1x" aria-hidden="true"></i></a>
